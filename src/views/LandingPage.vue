...
export default {
  ...
  computed: {
    ...
    filteredList() {
      return this.buku.filter((buku) => {
        return buku.kode.toLowerCase().includes(this.searchQuery.toLowerCase());
      });
    },
  },
  ...
  methods: {
    paginateBuku(pageBuku) {
      ...
      this.paginatedBuku = this.filteredList.slice(startIndex, endIndex);
    ...
    getList() {
      this.paginatedBuku = this.filteredList.slice(0, this.perPageBuku);
    },
  },
};
</script>
        ...
        <div v-for="(data, index) in paginatedBuku" :key="data.kode" class="col-md-3">
          <div class="card mb-4">
            ...
            <div class="d-flex justify-content-center">
              ...
              <button type="button" class="btn btn-primary btn-sm w-100 mb-2">Borrow</button>
              </router-link>
            </div>
            
            <div class="d-flex justify-content-center">
            <button type="button" class="btn btn-primary btn-sm w-50">Buy</button>
            </div>
