...
const postApi = 'insertbuku.php';
const delAPI = 'deletebukubykode.php';

const allKategori = 'selectallkategori.php';
const postApi2 = 'insertkategori.php';
const delAPI2 = 'deletekategoribykode.php';
